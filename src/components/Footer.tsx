  ...
  return (
    <>
      ...
      <footer className='relative overflow-hidden'>
        <div className='flex flex-col md:flex-row p-4 md:p-8 bg-neutral-950 text-slate-50 text-sm select-none'>
        ...
        <div className='flex justify-center items-center col-span-3 row-start-2 bg-neutral-950'>
