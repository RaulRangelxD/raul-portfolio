...
export default function Skills() {
  return (
    <section className='relative py-24 px-6'>
      {/* Background Glow */}
      <div className='absolute inset-0 -z-10 bg-linear-to-br from-cyan-500/10 via-transparent to-fuchsia-500/10 blur-3xl' />
            ...
            return (
              ...
              >
                ...
                <div className='relative flex flex-col items-center gap-4'>
                  ...
                  <p className='text-sm md:text-base font-medium tracking-wide text-white/80 group-hover:text-white transition-colors duration-300'>
                    {skill.name}
                  </p>
                </div>
              </motion.div>
