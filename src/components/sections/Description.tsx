...
export default function Description() {
  return (
    <>
      ...
      <section className='relative py-24 px-6 bg-neutral-950 text-slate-50 select-none'>
        <div className='flex flex-col min-h-screen items-start text-center p-4 md:p-8 '>
            ...
            >
              ...
              <div className='relative w-[80vw] md:w-[40vw] flex flex-col items-start gap-4 p-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-b-2xl rounded-r-2xl overflow-hidden shadow-2xl'>
                ...
                <p className='text-start'>
                  ...
                  , diseñando soluciones escalables, bien estructuradas y
                  pensadas para crecer sin perder claridad.
                </p>
                <GlowDivider />
                <p className='text-start'>
                  ...
                  , donde aplico principios de arquitectura, máquinas de estados
                  y sistemas modulares para crear mecánicas limpias y
                  reutilizables. Me interesa tanto la lógica interna como la
                  sensación que transmite el juego al jugador.
                </p>
              </div>
            </motion.div>
          </div>
